...
class StateController {
    ...
    var user = User(name: "John Doe", aboutMe: "I am the user of this app", profileImageURL: "Avatar", reputation: 100)
...
private extension StateController {
    class func createQuestions() -> [Question] {
        let question1: Question = {
            ...
            let owner = User(name: "michalepri", aboutMe: "Moderator Pro Tempore on Lifehacks.SE", profileImageURL: "michaelpri", reputation: 5276)
        ...
        let question2: Question = {
            ...
            let owner = User(name: "Daniel Storm", aboutMe: "Developing iOS applications to help you waste time, effectively. Latest application: Zero Views", profileImageURL: "DanielStorm", reputation: 194)
        ...
        let question3: Question = {
            ...
            let owner = User(name: "Thomas Johnson", aboutMe: "Apparently, this user prefers to keep an air of mystery about them.", profileImageURL: "Thomas Johnson", reputation: 153)
